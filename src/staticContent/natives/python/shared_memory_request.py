...
class SharedMemoryRequest(request_generator.RequestGenerator):
    ...
    def wait(self, namespace, variable_name, timeout_ms):
        self.action = 'wait'
        self.params = [namespace, variable_name, str(timeout_ms)]
...
class SharedMemoryInstance(object):
    ...
    def wait(self, variable_name, timeout_ms):
        return self.shared_memory_request.wait(self.namespace, variable_name, timeout_ms)
